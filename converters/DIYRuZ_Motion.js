...
const device = {
        ...
        exposes: [
            ...
            exposes.numeric('illuminance', ACCESS_STATE).withDescription('Raw measured illuminance'), 
            exposes.numeric('illuminance_lux', ACCESS_STATE).withUnit('lx').withDescription('Measured illuminance in lux'),
